...
#' the \code{\link{auto.arima}} function in the \code{forecast} package. In
...
#' details, see the \code{\link{auto.arima}} function in the \code{forecast}
...
#' @seealso \code{\link{auto.arima}}, \code{\link{predict.Arima}},
