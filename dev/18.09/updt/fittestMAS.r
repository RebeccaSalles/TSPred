...
#' Automatic prediction with moving average smoothing %% ~~function to do ...
#' ~~
#' 
...
#' above ~~
#' 
#' @param timeseries A vector or univariate time series. %% ~~Describe
...
#' the interval \code{minorder:maxorder}. See 'Details'. %% ~~Describe
#' \code{maxorder} here~~
...
#' if \code{order} is provided. See 'Details'. %% ~~Describe \code{maxorder}
#' here~~
...
#' fitting and prediction of the moving average smoothed series. %% ~~Describe
#' \code{na.action} here~~
...
#' @seealso \code{\link{fittestEMD}}, \code{\link{fittestWavelet}} %% ~~objects
