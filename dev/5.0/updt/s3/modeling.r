...
#'
#' n <- NNET(size=5, sw=SW(window_len = size+1), proc=list(MM=MinMax()))
...
#' @param ... Other parameters passed to \code{pred_func} of \code{obj}.
...
#'
#' For \code{predict.MLM}, \code{sw} of \code{obj} may be used to transform the time series 
#' input in \code{data} into sliding windows used during prediction. Also, 
#' \code{proc} of \code{obj} may be used to preprocess/postprocess the input during prediction.
#'
#' @return A list containing \code{obj} and the produced predictions.
#' @author Rebecca Pontes Salles
#' @family predict
#'
